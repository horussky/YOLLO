<?php
	...
	$geolocation = array(
			...
			"hotel1"=> array(
				"title" 			=>"Musiq Mall",
				"address"			=>"1709 1st Avenue N",
				"location"			=>"Birmingham, AL",
				"geolocation"		=>"1709+1st+Avenue+North+Birmingham+A+35203",
				"zoom"				=>"14", //8-16
    ...
    <div id="container">
        ...
        <div id="right">
            ...
            <div class="topcontent">
                    <img src="images/slides/splash-comedy-bham.jpg" alt="<?php echo $event["title"] ?> with Yollo Group Services Inc." />
            </div> <!-- ./topcontent-->
          ...
          <div class="content">
                   ...
                   <div class="col1">
                        ...
                        <div id="tabs-4">
                            ...
                            The comedy show is being hosted at the Musiq Mall. It's located in Birmingham, AL.
                            </li>
...
<input type="hidden" name="hosted_button_id" value="C5BTT6TTZYZ7L">
