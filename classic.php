<?php
	...
	$event = array(
		"title"				=>"Magic City Classic 2017",
		"location"			=>"Legion Field | Birmingham, Alabama",
		"date"				=>"Oct 27-29, 2017",
		"img_url"			=>"../../images/slides/splash-mcc.jpg",
...
<div id="wrap">
  ...
  <div id="container">
    ...
    <div id="right">
      <div class="topcontent"> <img src="<?php echo $event["img_url"]; ?>" alt="<?php echo $event["img_alt"]; ?>" > </div>
      <div class="content">
            ...
            <div id="tabs-3">
              <div id="accordion" class="nodisp">
                <section>
                  ...
                  <p>After registration the 1st payment of $50 is due on or before due May 17, 2017. The second and final payment is due August 08, 2017.</p>
                </section>
                <section>
