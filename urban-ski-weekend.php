...
$event = array(
	...
	"subtitle"			=>"As Seen on Love & Hiphop",
		...
		<div class="content">
			...
			<div class="colfull">
				...
				<div class="tab" aria-label="overview">
					...
					<p>Our packages offer an incredible range of features including a hotel stay, party passes, a comedy show and more. We even provide exclusive party buses in Alabama and Tennessee to make your experience even better!</p>
				...
				<div class="tab" aria-label="faqs">
					...
					<div data-accordion-group>	
						...
						<div class="accordion open" data-accordion>
							...
							<p>Following registration the first payment of $250 is due on or before December 02, 2023.  The second payment of $350 is due on or before January 03, 2024. The final payment (remaining balance) is due on or before January 17, 2024. If the announced payment dates have passed contact us for our current payment plan. Any payments after the due date will incur late fees and is subject to cancellation. If you would like to make payments between due dates you may do so by clicking on the BUY NOW tab above and following the prompts.</p>
