		...
		<div class="content">
			...
			<div class="colfull">
				...
				<div class="tab" aria-label="overview">
					...
					<p>Our packages offer an incredible range of features including a hotel stay, party passes, a comedy show and more. We even provide exclusive party buses to make your experience even better! Last year our attendees got up close and person with Young Dro and Travis Porter. Each year the celebrity list gets BIGGER!</p>
				...
				<div class="tab" aria-label="faqs">
					...
					<div data-accordion-group>	
						...
						<div class="accordion open" data-accordion>
							...
							<p>Following registration the first payment of $125 is due on or before June 22, 2023.  The second payment of $200 is due on or before August 02, 2023. The final payment (remaining balance) is due on or before October 5, 2023. If the announced payment dates have passed contact us for our current payment plan. Any payments after the due date will incur late fees and is subject to cancellation. If you would like to make payments between due dates you may do so by clicking on the BUY NOW tab above and following the prompts.</p>
