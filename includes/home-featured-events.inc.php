<?php
    ...
    class Event {
        ...
        public function __construct($title, $location, $date, $start, $end, $img, $link, $desc, $link2) {
            $this->title = $title;
    ...
    $feature_event = [
        new Event(
            ...
            "July 24-26, 2026", //date
            strtotime("July 24, 2026"), //start
            strtotime("July 26, 2026"), //end
        ...
        new Event(
            ...
            "New Orleans, LA",
            "July 3-6, 2026",
            strtotime("July 3, 2026"),
            strtotime("July 6, 2026"),
        ...
        new Event(
            ...
            strtotime("October 30, 2026"),
            strtotime("November 1, 2026"),
        ...
        new Event(
            ...
            "Gatlinburg, TN",
            "Feb 5 - Feb 8, 2027",
            strtotime("February 5, 2027"),
            strtotime("February 8, 2027"),
        ...
        new Event(
            ...
            "Bahamas, Amber Cove, Grand Turk",
            "December 14-20, 2026",
            strtotime("December 14, 2026"),
            strtotime("December 20, 2026"),
            "images/slides/splash-alumni.jpg",
            "/alumni-getaway-cruise",
            "HBCU alums, join YOLLO for a cruise to Bahamas, Amber Cove, Grand Turk!",
            "/booklet"
        ),
        new Event(
            "London To Paris",
