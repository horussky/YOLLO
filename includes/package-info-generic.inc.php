...
<section id="package-info-box">
	<div>
		<p><strong>Important Package Information</strong> | Our refund policies are located on the main <a href="/faq" title="Frequently Asked Questions">FAQs page</a>. Hotel images are used for descriptive purposes only. Hotel room types are not guaranteed and may vary due to availability. Individual event passes, if applicable to the package, are provided per person. Package price includes only one room per group. Package prices do not include: registration, taxes, service or late fees. For event specific questions, please view the FAQs tab or use the form on the <a title="contact us" href="/contact">Contact Us</a> page for any questions you may have.</p>
		
		<p><strong>Accepted Payments</strong> | <i class="ccs ccs-visa"><span></span></i> <i class="ccs ccs-mastercard"><span></span></i> <i class="ccs ccs-discover"><span></span></i> <i class="ccs ccs-amex"><span></span></i> </p>
