...
$event = array(
	...
	"location"				=> "Cozumel and Progreso, Mexico",
            ...
            <div class="content">
                ...
                <div class="colfull">
                    ...
                    <?php echo $responsive_tabs["overview"]; ?>
                        ...
                        <h3>Alumni Getaway is going to Cozumel and Progreso, Mexico!</h3>
                        ...
                        <p>While you cruise over the Caribbean, we have plenty of entertainment to keep you occupied. Look forward to comedy shows, a talent show, spades tournament, and more activities. Our DJ's are working the 1's and 2's for a variety of onboard clubs and decks. Our theme night parties, “Ocean Blue Fun and Sexy Party” and “Mardi Gras themed Glow Party” will also keep the camaraderie going all weekend.</p> 
                        <p>Don't believe the hype, Mexico is a very beautiful place to visit. Cozumel and Progreso has plenty of excursions and shopping areas to explore. If time permits, tour the Mayan ruins or cruise the island and enjoy the scenery. So do not hesitate on this package. Book this great cruise package today!</p>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Monday</td>
                            <td>Yucatan, MX 8AM-5PM</td>
                          </tr>
                          <tr>
                            <td>Tuesday</td>
                            <td> Cozumel, MX  9AM-5PM</td>
                          </tr>
                          <tr>
                            <td>Wednesday</td>
                            <td>Fun Day At Sea</td>
					...
					<div class="tab" aria-label="faqs">
                        ...
                        <div data-accordion-group>	
							...
							<div class="accordion" data-accordion>
							  ...
							  <div data-content>
								<p>In Cozumel you may use USD or the Mexican Peso. Be aware, rates for the MX Peso vary shop to shop. We suggest downloading a Currency app to have at least a ball park amount of what things cost in Cozumel. If you have a traveling credit card, like an expedia Master Card, most shops will allow for credit transactions. If using a credit card, ask to have it charged in Peso's instead of USD. You will save a few dollars doing so.</p>
                                  <p>
                                      You can also say "quanto questo" to ask how much something costs if the natives cannot understand you.
                                  </p>
							  </div>
							...
							<div class="accordion" data-accordion>
							  ...
							  <div data-content>
								<p>No. Though everyone may not speak English, a majority of tourist areas around Mexico do speak or understand simple English. Knowing some Spanish will definitely help, however, Cozumel is a large tourist island, and many of the shop owners and cab drivers are Bilingual. Just to be on the safe side, you should download the <a href="https://itunes.apple.com/us/app/google-translate/id414706506?mt=8">Google Translate App</a> or <a href="https://translator.microsoft.com/apps/" target="_blank">Microsoft Translate app</a> on your smartphone. Both apps are free and can translate Spanish to English and vice versa, translate words from images/signs/etc, and listen to conversation and translate in real-time. Both apps are for Android and iOS devices. We recommend downloading the Spanish language pack for offline use if you are not near wifi or you do not have an international mobile plan. </p>
							  </div>
							...
							<div class="accordion" data-accordion>
							  ...
							  <div data-control>Any tips or anything to be aware of while on the island?</div>
							  <div data-content>
								<ul>
									<li>Make sure you visit multiple shops before buying anything. Cozumel has many shops on the island and many of them sell the exact same items or similiar at different prices. Make sure you are getting the best price and quality for your money.</li>
                                    <li>Small shops you can negotiate prices. Generally $10-$15 below asking price can get you a deal.</li>
									<li>Don't venture too far from the main shopping areas. Many of the known brand name vendors are closer to the main strip.</li>
                                    <li>Visit most shops on the main strip for a free token or small gift. These can make good giveaway gifts to friends without having to spend money.</li>
                                    <li>You can rent scooters or small cars but be aware the roads will be really busy, due to many other visitors on the road at the same time.</li>
									<li>If buying tequila, we highly recommend buying the local Mexican brands. Yes, you may find a good price for Patron, but you can find that brand anywhere in the States. Many shops do free tastings for their liquor. Even if you don't buy, you can get a good buzz without spending a dime.</li>
                                    <li>There is enough time from port/departure to ferry to Playa Del Carmen, Mexico (5th Avenue). There are many more shops and better prices on liquor there. You can take the UltraMar Ferry. It's approximately a 25min ferry, and it runs every hour on the hour. Cost of round trip range from $15-$20. If your boarding time is 5PM it is recommended you catch the 3PM ferry to assure you have enough time to board the cruise ship. </li>
								</ul>
							  </div>
							...
							<div class="accordion" data-accordion>
							  ...
							  <div data-content>
								<ul>
									...
									<li>Tequila come in different qualities. White (Blanco)/Silver, Gold, Resposado, Anejo (2-3 years aged), Extra Anejo (3+ years aged). The latter two being the most aged and smoothest.</li>  
									<li>We recommend finding a good Anejo [AN-YE-HO] (3 years aged) or Extra Anejo (3+ years aged) sipping Tequila; (most look and taste like a brandy). The older the Tequila, the smoother and sweeter (or smoky) the taste. Once you taste one of these fine spirits, you may throw out all your Patron's at home. Some brands to ask for: Mañana [MAN-YON-NUH], Adictivo, or Milagro. Anejo tequila are more premium in price, but the taste is well worth the cost. Also try a premium Mezcal called Zignum. </li>
									<li>Outside of sipping tequila, there are some liqueur and creams you may be interested in such as: Sheridan coffee liqueur, 1921 assorted flavor tequila, and Almond flavored tequila.</li>
								</ul>
							  </div>
