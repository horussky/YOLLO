                ...
                <div class="colfull">
                    ...
                    <div id="responsive-tabs">
                        ...
                        <div class="tab" aria-label="overview">
                            <h2>Where the Game Meets the Ultimate Vibe </h2>

                            <p>All-Star Weekend isnt just a sporting event, it's a full-blown cultural takeover, and YOLLO is once again setting the standard for how it's done. In 2027, we're bringing together basketball's biggest moments, electrifying nightlife, and a grown-and-sophisticated crowd that knows how to show up and show out. From the opening tip to the final afterparty, YOLLO All-Star Weekend 2027 is designed for fans who want more than a seat in the arena but want a complete, elevated experience!.</p>

                            <p>This weekend delivers the All-Star energy you expect, taken to the next level. Guests can look forward to the excitement of All Star weekend events paired with intentionally curated YOLLO experiences. From high-energy day parties to celebrity-hosted nightlife, every moment is thoughtfully planned to keep the vibe flowing all weekend long. Beyond the events themselves, the experience is rooted in culture, connection, and celebration, bringing together professionals, tastemakers, alumni, and true basketball lovers from across the country.</p>
                        ...
                        <div class="tab" aria-label="price">
                            ...
                            <div class="hotel-grid">
                                <div class="hg-img">
                                    <?php $hotel_img = !empty($hotel['img_url']) ? $hotel['img_url'] : '/images/hotel-default.jpg'; ?>
                                    <figure style="background:url('<?php echo $hotel_img; ?>'); background-size: cover; background-position: center;"></figure>
                                </div>
