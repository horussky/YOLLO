...
(function ($) {
  $.fn.tweet = function (o) {
    var s = $.extend({
      ...
      comparator: function comparator(tweet1, tweet2) {
...
!function (e, t, n) {
  function r(e, t) {
    ...
    var e, t, n, a, o, c, l;for (var f in s) {
      if (s.hasOwnProperty(f)) {
        if (e = [], t = s[f], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) {
          ...
          c = e[o], l = c.split("."), 1 === l.length ? Modernizr[l[0]] = a : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = a), i.push((a ? "" : "no-") + l.join("-"));
        }
      }
    }
  }function o(e) {
    var t = l.className,
        n = Modernizr._config.classPrefix || "";if (f && (t = t.baseVal), Modernizr._config.enableJSClass) {
      ...
      Modernizr = function Modernizr() {};Modernizr.prototype = c, Modernizr = new Modernizr();var l = t.documentElement,
      f = "svg" === l.nodeName.toLowerCase();f || !function (e, t) {
    function n(e, t) {
      ...
      var n = C.elements;"string" != typeof n && (n = n.join(" ")), "string" != typeof e && (e = e.join(" ")), C.elements = n + " " + e, l(t);
    }function o(e) {
      var t = T[e[N]];return t || (t = {}, S++, e[N] = S, T[S] = t), t;
    }function i(e, n, r) {
      if (n || (n = t), v) return n.createElement(e);r || (r = o(n));var a;return a = r.cache[e] ? r.cache[e].cloneNode() : b.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !a.canHaveChildren || E.test(e) || a.tagUrn ? a : r.frag.appendChild(a);
    }function s(e, n) {
      if (e || (e = t), v) return e.createDocumentFragment();n = n || o(e);for (var a = n.frag.cloneNode(), i = 0, s = r(), c = s.length; c > i; i++) {
        a.createElement(s[i]);
      }return a;
    }function c(e, t) {
      ...
      e || (e = t);var r = o(e);return !C.shivCSS || h || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), v || c(e, r), e;
    }function f(e) {
      for (var t, n = e.getElementsByTagName("*"), a = n.length, o = RegExp("^(?:" + r().join("|") + ")$", "i"), i = []; a--;) {
        t = n[a], o.test(t.nodeName) && i.push(t.applyElement(u(t)));
      }return i;
    }function u(e) {
      for (var t, n = e.attributes, r = n.length, a = e.ownerDocument.createElement(x + ":" + e.nodeName); r--;) {
        t = n[r], t.specified && a.setAttribute(t.nodeName, t.nodeValue);
      }return a.style.cssText = e.style.cssText, a;
    }function d(e) {
      for (var t, n = e.split("{"), a = n.length, o = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), i = "$1" + x + "\\:$2"; a--;) {
      ...
      function t() {
        clearTimeout(i._removeSheetTimer), r && r.removeNode(!0), r = null;
          ...
          i = o(e),
          s = e.namespaces,
          c = e.parentWindow;return !j || e.printShived ? e : ("undefined" == typeof s[x] && s.add(x), c.attachEvent("onbeforeprint", function () {
        t();for (var o, i, s, c = e.styleSheets, l = [], u = c.length, m = Array(u); u--;) {
          m[u] = c[u];
        }for (; s = m.pop();) {
        ...
        }l = d(l.reverse().join("")), a = f(e), r = n(e, l);
    ...
    }();C.type += " print", C.shivPrint = p, p(t), "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = C);
  }("undefined" != typeof e ? e : this, t), a(), o(i), delete c.addTest, delete c.addAsyncTest;for (var u = 0; u < Modernizr._q.length; u++) {
    Modernizr._q[u]();
