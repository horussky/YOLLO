...
<head>
<meta charset="utf-8">
<title><?php echo $metas['privacy']['title']; ?></title>

<meta name="description" content="<?php echo $metas['privacy']['desc']; ?>" />
<meta name="keywords" content="<?php echo $metas['privacy']['keywords']; ?>" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="google-site-verification" content="aOAfb-SvmTm_gQdN1mBdu4VN7r6JudKkeJ93Y2B8SLE" />
<link href="<?php echo $metas['privacy']['canonical']; ?>" rel="canonical" />
            ...
            <div class="row mb-40">
                ...
                <h2 class="title">Privacy Policy</h2>
                    ...
                    <ul>
                        ...
                        <li><p><strong>Website</strong> refers to YOLLO Group Services, accessible from <a href="https://www.goyollo.com" rel="external nofollow noopener" target="_blank">https://www.goyollo.com</a></p></li>
                    ...
                    <ul>
                    <li>
                    <p>By email: onelife@goyollo.com</p>
                    </li>
                    <li>
                    <p>By visiting this page on our website: <a href="https://www.goyollo.com/contact" rel="external nofollow noopener" target="_blank">https://www.goyollo.com/contact</a></p>
                    </li>
                    <li>
                    <p>By phone number: 888.946.9655</p>
                    </li>
                    </ul>
                    </div>
                </div><!-- end of col-->
