<?php
	...
	$event = array(
		...
		"img_url"			=>"../../images/slides/splash-egypt-cta.jpg",
		"img_alt"			=>"Egypt Takeover 2023",
	);
...
<head>
    <meta charset="utf-8">
    <title><?php echo $metas['egypt']['title']; ?></title>
    <meta name="viewport" content="width=device-width">
    <meta name="description" content="<?php echo $metas['egypt']['desc']; ?>" />
    <meta name="keywords" content="<?php echo $metas['egypt']['keywords']; ?>" />
    <meta name="google-site-verification" content="aOAfb-SvmTm_gQdN1mBdu4VN7r6JudKkeJ93Y2B8SLE" />
    <link href="<?php echo $metas['egypt']['canonical']; ?>" rel="canonical" />
            ...
            <div class="content">
                   ...
                   <div class="colfull">
                     ...
                     <div id="responsive-tabs">
						...
						<h2 class="h4">We are taking over Cairo!</h2>

						<p>Step into a world of exotic splendor, where temperatures are balmy, majestic minarets pierce the sky, and the reverberation of the muezzin's prayer fills the air with tranquility. Cairo is truly a captivating city, with a fascinating history and stunning sights. Cairo has an energy that makes it irresistible to explore and uncover its secrets. From its stunning architecture to its vibrant culture, Cairo will never disappoint. If you're looking for an exciting excursion, Cairo could be the perfect destination for a short break. It is an energetic city with plenty of activities to keep you engaged.</p>

						<p>Our Egypt package includes a Camel and ATV rides, Cairo City tour, Hot Air Ballon tour, Cruise, and more. Airfare is not included. <strong>Passports are required. Vaccinations will not be required, but is subject to change in the future. </strong></p>
						...
						<div class="tab" aria-label="price">
                                ...
                                <div class="hotel-grid">
                                    <div class="hg-img">
										<?php if(empty($hotel['img_default'][0])) :?>
                                        <figure style="background:url(../../images/hotel-default.jpg); background-size: cover; background-position: center;"></figure>
										<?php else: ?>
						...
						<div class="tab" aria-label="buy">
							...
							<script src="https://www.cognitoforms.com/f/seamless.js" data-key="NiNAkf4LukqBZOHDFOMsiQ" data-form="75"></script>
